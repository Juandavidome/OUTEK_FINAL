    ...
    <body>
        ...
        <form action="Controlador?menu=NuevaVenta" method="POST">
            ...
            <div class="consul-compra">
                ...
                <label>Cedula</label>
                <br>
                <input type="text" name="codigocliente" value="<%=usuario.getUsuCedula()%>"  readonly onmousedown="return false;" class="ConsulInputCom" placeholder="Cedula Cliente" >
                <br>
                <label>Nombre</label>
                <input type="text" name="nombrescliente" value="<%=usuario.getUsuNombre()%>" class="ConsulInputCom" placeholder="Nombre Cliente" readonly onmousedown="return false;">
            </div>
        ...
        <div class="containerVenta">
                ...
                <tbody>
                    <c:forEach var="list" items="${lista}">
                        <tr>
                            ...
                            <td>
                                <a href="Controlador?menu=NuevaVenta&accion=Eliminar&indice=${list.item}" class="btn" style="margin-left: 10px">Eliminar</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
            ...
            <div class="button-container">
                <a href="Controlador?menu=NuevaVenta&accion=GenerarVenta"  onclick="print()" class="btnReact">Generar Venta</a>
                <a href="Controlador?menu=NuevaVenta&accion=CancelarOrden"  class="btn">Cancelar Venta</a>
            </div>
            <br>
